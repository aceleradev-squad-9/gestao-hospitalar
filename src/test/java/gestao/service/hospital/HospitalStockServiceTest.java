  ...
  @Test
	...
	public void shouldThrowsHospitalNotFoundWhenAddStockProduct() {
		...
		assertThrows(HospitalNotFoundException.class,
				() -> hospitalStockService.addProductInStock(HOSPITAL_ID, Mockito.any(), PRODUCT_AMOUNT));
	...
	@Test
	@DisplayName("Deve ser refeito: Deve transferir produtos entre hospitais mais próximos.")
	public void shouldOrderProductFromNearestHospital() {
		...
		// when(mockedHospitalService.findNearestHospitals(hospitals, hospitalA.getAddress()))
	...
	@Test
	@DisplayName("Deve ser refeito: Deve transferir produtos entre um hospital e o segundo mais próximo caso o primeiro possua a quantidade mínima de produtos. ")
	...
	@Test
	@DisplayName("Deve ser refeito: Deve lançar a exceção NearestHospitalNotFoundException quando não existirem hospitais próximos com estoque disponível para transferẽncia.")
